    ...
    <div className="max-w-4xl mx-auto p-6 bg-gray-800 rounded-xl shadow-lg">
      <div className="space-y-6">
        ...
        <div className="space-y-2">
            ...
            {referenceImageUrl ? (
                <div className="relative w-full h-40 group bg-gray-900 rounded-lg p-1">
                ...
                <div className="relative w-full h-24 border-2 border-dashed border-gray-600 rounded-lg flex items-center justify-center hover:border-gray-500 transition-colors">
                    <input 
                        type="file" 
                    ...
                    />
                    <label htmlFor="reference-upload" className="text-center text-gray-500 cursor-pointer">
      ...
      <div className="mt-8">
        ...
        <div className="mt-6 aspect-w-1 aspect-h-1 w-full max-w-lg mx-auto bg-gray-900 rounded-lg flex items-center justify-center overflow-hidden min-h-[30rem]">
          {isLoading && (
